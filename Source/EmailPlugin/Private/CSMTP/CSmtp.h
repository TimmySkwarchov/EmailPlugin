...
public:
	...
	void AddRecipient(const FString *email, const FString *name=NULL);
	void AddBCCRecipient(const FString *email, const FString *name=NULL);
	void AddCCRecipient(const FString *email, const FString *name=NULL);    
	void AddAttachment(const FString *path);   
	void AddMsgLine(const FString* text);
	void ClearMessage();
	bool ConnectRemoteServer(const FString* szServer, const unsigned short nPort_=0,
